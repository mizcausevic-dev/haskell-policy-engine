...
### Released
- Published **haskell-policy-engine** as a public, portfolio-grade identity governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **haskell-policy-engine**.
...
- That insight became the basis for **haskell-policy-engine**.
